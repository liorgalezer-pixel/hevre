      ...
      <main className="flex-1 pb-24">
        {conversations.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full py-24 px-8 text-center gap-4">
            ...
            <h2 className="text-lg font-black text-gray-700">אין צ׳אטים עדיין</h2>
            <p className="text-sm text-gray-400 leading-relaxed">
              ברגע שעסק יקבל את המועמדות שלך, תיפתח כאן שיחה
            </p>
          </div>
        ) : (
          <div className="flex flex-col">
            {conversations.map((conv) => (
              <button
                ...
                className="flex items-center gap-3 px-4 py-4 bg-white border-b border-gray-100 active:bg-gray-50 text-right"
              >
